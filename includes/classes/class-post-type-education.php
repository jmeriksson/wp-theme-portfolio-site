<?php
/**
 * Creates a custom post type: Education
 *
 * @package mikaeleriksson
 */

class Post_Type_Education extends Loader {
	/**
	...
	public function register_post_type() : void {
		$singular_name = _x( 'Education', 'post type singular name', 'mikaeleriksson' );
		$plural_name   = _x( 'Educations', 'post type plural name', 'mikaeleriksson' );
		$labels        = [
			'name'               => $plural_name,
			'singular_name'      => $singular_name,
			'add_new'            => _x( 'Add new', 'education', 'mikaeleriksson' ),
		...
		$args          = [
			'name'              => __( 'Educations', 'mikaeleriksson' ),
			'labels'            => $labels,
			'public'            => true,
			'show_ui'           => true,
			'show_in_menu'      => true,
